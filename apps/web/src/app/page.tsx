...
const steps = [
  { id: "input_analysis", label: "입력 분석" },
  { id: "patent_search", label: "특허 검색" },
  { id: "claim_parsing", label: "청구항 분석" },
  { id: "feature_matching", label: "기능 매칭" },
  { id: "report_generation", label: "리포트 생성" },
];
    ...
    <main className="min-h-screen">
      ...
      <div className="mx-auto grid max-w-7xl gap-4 px-5 py-5 lg:grid-cols-[360px_1fr_360px]">
        <section className="rounded-md border border-[#d8d3c6] bg-white p-4">
          <div className="mb-4">
            <h2 className="text-base font-semibold">제품/기술 설명</h2>
        ...
        <section className="rounded-md border border-[#d8d3c6] bg-white">
          <div className="border-b border-[#e5e0d4] p-4">
            <h2 className="text-base font-semibold">Agent 진행 흐름</h2>
            <p className="mt-1 text-sm text-[#69707a]">
          ...
          <div className="border-t border-[#e5e0d4] p-4">
            <h3 className="mb-3 text-sm font-semibold">이벤트 스트림</h3>
            <div className="max-h-72 overflow-auto rounded-md bg-[#20242a] p-3 font-mono text-xs text-[#e9edf2]">
              {events.length === 0 ? (
                <p className="text-[#aab2bd]">아직 Agent 이벤트가 없습니다.</p>
              ) : (
        ...
        <aside className="grid gap-4">
          <section className="rounded-md border border-[#d8d3c6] bg-white p-4">
            <h2 className="text-base font-semibold">근거 패널</h2>
            <p className="mt-1 text-sm text-[#69707a]">
              특허 후보, 청구항 원문, 매칭 근거를 보여줄 영역입니다.
            </p>
            <div className="mt-4 rounded-md border border-[#e5e0d4] bg-[#fbfaf7] p-3 text-sm">
              <p className="font-semibold">핵심 검토 대상</p>
              <p className="mt-1 text-[#69707a]">독립항과 기술 기능의 겹치는 부분입니다.</p>
            </div>
          </section>

          <section className="rounded-md border border-[#d8d3c6] bg-white p-4">
            <h2 className="text-base font-semibold">청구항 대조표</h2>
          ...
          <section className="rounded-md border border-[#d8d3c6] bg-white p-4">
            <h2 className="text-base font-semibold">리포트 초안</h2>
            <p className="mt-3 whitespace-pre-wrap rounded-md bg-[#fbfaf7] p-3 text-sm text-[#4b4f55]">
              {String(report?.data?.markdown ?? "아직 생성된 리포트가 없습니다.")}
            </p>
          </section>
        </aside>
      </div>
